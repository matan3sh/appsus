...
import ReviewList from '../../components/Book/Reviews/ReviewList.jsx';
import ReviewRate from '../../components/Book/Reviews/ReviewRate.jsx';
import ReadMore from '../../components/Book/ReadMore.jsx';
      ...
      <div className='container'>
        <div className='grid-1'>
          <div className='card grid-2'>
            ...
            <div>
              <h2 className='text-left book-title-details'>
                {book.title.charAt(0).toUpperCase() + book.title.slice(1)}{' '}
                <span className='book-subtitle-details'>- {book.subtitle}</span>
              </h2>
